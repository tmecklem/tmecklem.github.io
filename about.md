...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <span class="px-3 py-1 rounded-full text-sm font-medium" style="background-color: var(--color-accent); color: white;">AI/LLM Tools</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Education -->
  <section class="mb-12">
    <h2 class="text-2xl font-bold mb-4" style="color: var(--color-text);">Education</h2>
    <div class="space-y-4">
      <div class="pl-4" style="border-left: 4px solid var(--color-border);">
        <h3 class="text-lg font-semibold" style="color: var(--color-text);">MBA</h3>
        <p style="color: var(--color-secondary);">Xavier University</p>
        <p class="text-sm" style="color: var(--color-secondary); opacity: 0.8;">Beta Gamma Sigma - International Business Honor Society</p>
      </div>
      <div class="pl-4" style="border-left: 4px solid var(--color-border);">
        <h3 class="text-lg font-semibold" style="color: var(--color-text);">Bachelor's degree in Computer Science</h3>
        <p style="color: var(--color-secondary);">University of Cincinnati</p>
      </div>
    </div>
  </section>
  ...
  <section class="mb-12">
    <h2 class="text-2xl font-bold mb-4" style="color: var(--color-text);">Community Involvement</h2>
    <ul class="space-y-3">
      <li class="flex items-start">
        <svg class="w-6 h-6 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-primary);">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span style="color: var(--color-secondary);">Board Member at Cincinnati Computer Reuse</span>
      </li>
      <li class="flex items-start">
        <svg class="w-6 h-6 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-primary);">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span style="color: var(--color-secondary);">Co-organizer for Ohio Elixir Meetup</span>
      </li>
      <li class="flex items-start">
        <svg class="w-6 h-6 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-primary);">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span style="color: var(--color-secondary);">Co-organizer for Cincinnati Ruby Brigade</span>
      </li>
      <li class="flex items-start">
        <svg class="w-6 h-6 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-primary);">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span style="color: var(--color-secondary);">Co-organizer for Cincinnati JavaScript Meetup</span>
      </li>
      <li class="flex items-start">
        <svg class="w-6 h-6 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-primary);">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
